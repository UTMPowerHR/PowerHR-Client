...
function TableEmployees() {
    ...
    // const { data: employees, isLoading, error } = useGetEmployeesQuery(user.company);
    ...
    //         hireDate: '2021-03-12',
    //         terminationDate: '2024-12-01', // Example future date
    //         gender: 'Female',
    //         salary: 85000,
    //     },
    // ]);
        ...
        setTimeout(() => {
            setEmployees((prevEmployees) =>
                prevEmployees.map((emp) =>
                    emp._id === selectedEmployee._id ? { ...emp, terminationDate: dayjs().format() } : emp
                )
            );
